...
const navigationConfig = [
  {
    ...
    type: "item",
    icon: "dashboard",
    url: "/venapp/dashboard",
  },
  {
    id: Menus.INVESTPLANS,
    title: "Investment Plans",
    translate: "INVESTPLANS",
    auth: authRoles.investUser,
    type: "item",
    icon: "today",
    url: "/venapp/investmentplan",
  },
  {
    id: Menus.LOGS,
    title: "Logs",
    ...
    children: [
      {
        id: Menus.RETINTLOG,
        title: "Return Interest Log",
        translate: "RETINTLOG",
        auth: authRoles.investUser,
        type: "item",
        icon: "insert_chart_outlined",
        url: "/venapp/interestlog",
        isChildren: true,
      },
      {
        id: Menus.TRANSHISTORY,
        title: "Transaction History",
        translate: "TRANSHISTORY",
        auth: authRoles.investUser,
        type: "item",
        icon: "museum",
        url: "/venapp/transhistory",
        isChildren: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        translate: "DEPHISTORY",
        auth: authRoles.investUser,
        type: "item",
        icon: "library_books",
        url: "/venapp/deposithistory",
        isChildren: true,
      },
      {
        id: Menus.WITHHISTORY,
        title: "Withdraw History",
        translate: "WITHHISTORY",
        auth: authRoles.investUser,
        icon: "receipt_long",
        type: "item",
        url: "/venapp/withdrawhistory",
        isChildren: true,
      },
    ],
  },
  {
    id: Menus.REFERRALSTATS,
    title: "Referral Statistic",
    translate: "REFERRALSTATS",
    auth: authRoles.investUser,
    type: "item",
    icon: "family_restroom",
    url: "/venapp/referralstats",
  },
  {
    id: Menus.PROFILE,
    title: "Profile",
  ...
  },
  {
    ...
    children: [
      {
        id: Menus.DEPOSITAPPROVE,
        title: "Deposit Approve",
        translate: "DEPAPPROVE",
        auth: authRoles.investAdmin,
        type: "item",
        icon: "beenhere",
        url: "/venapp/approvedeposit",
      },
      {
        id: Menus.WITHDRAWAPPROVE,
        title: "Withdraw Approve",
        translate: "WITHAPPROVE",
        auth: authRoles.investAdmin,
        type: "item",
        icon: "beenhere",
        url: "/venapp/approvewithdraw",
      },
      {
        id: Menus.CHANGEPASS,
