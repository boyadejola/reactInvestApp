...
import DriverHeader from "./transactionHistoryHeader";
import DriverTable from "./transactionHistoryTable";
...
function TransactionHistory() {
  ...
  return checkLoader ? (
    ...
    <Root header={<DriverHeader />} content={<DriverTable />} innerScroll />
  ) : (
    <Error401 />
  );
}
