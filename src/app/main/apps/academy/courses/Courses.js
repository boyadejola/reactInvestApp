      ...
      >
        <div className="flex flex-col max-w-2xl mx-auto w-full p-24 sm:p-32">
          ...
          >
            <Typography
              color="inherit"
              className="text-18 sm:text-20 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
      ...
      <div className="flex flex-col flex-1 max-w-full w-full mx-auto px-8 sm:px-16 py-24">
        <div className="flex flex-col sm:flex-row items-center justify-between py-24">
          <div className="mx-6">
            <Typography
              color="inherit"
              className="text-18 font-bold sm:text-20 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
              {i18next.t(`navigation:WELPICHEAD1`)}
            </Typography>
            <Typography
              color="inherit"
              className="text-12 sm:text-16 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
              {i18next.t(`navigation:WELPICHEAD2`)}
            </Typography>
          </div>

          <img className="w-full" src="assets/images/header.png" />
        </div>
        ...
        <div className="flex sm:flex-row items-center justify-center py-24">
          <div className="mx-6">
            <Typography
              color="inherit"
              className="text-24 font-bold sm:text-32 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
              {i18next.t(`navigation:MARKETCAPWIDG`)}
            </Typography>
            <Typography
              color="inherit"
              className="text-18 font-semibold sm:text-24 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
              {i18next.t(`navigation:MARKETCAP1`)}
            </Typography>
            <Typography
              color="inherit"
              className="text-12 sm:text-18 mt-8 sm:mt-16 opacity-75 leading-tight sm:leading-loose text-center"
            >
