        ...
        {["Deposit", "Trade", "Interest"].map((label, index) => (
          ...
          <div key={label} className="px-16 flex flex-col items-center">
            ...
            <Typography className="text-18 font-semibold py-8">
              {index === 0 && dashData && dashData.totaldeposit
                ? dashData.totaldeposit
                : index === 1 && dashData && dashData.totaltrades
                ? dashData.totaltrades
                : index === 2 && dashData && dashData.interestwallet
                ? dashData.interestwallet
                : 0}
