...
function DepositNowContent(props) {
  const amount =
    props.amount && props.amount.split(":").length > 1
      ? props.amount.split(":")[1]
      : false;
      ...
      <FuseScrollbars className="flex-grow overflow-x-auto">
        {amount && (
          <div className="p-16 sm:p-24 max-w-2xl">
            <motion.div
              variants={item}
              className="widget flex w-full p-8 mt-12"
            >
              <div className="flex items-center justify-between px-4 pt-8 pb-12">
                <Typography
                  className="text-24 px-16 font-semibold"
                  color="HighlightText"
                >
            ...
            >
              <div className="flex items-center justify-between px-4 pt-8">
                <Typography
                  className="text-18 px-16 font-semibold"
                  color="HighlightText"
                >
            ...
            <Button
              ...
              onClick={() => {
                if (getTransDetail && amount) {
                  ...
                  dispatch(
                    handleResponse(false, false, true, "TRANSDETPROVIDE")
                  );
                }
              }}
            >
