        ...
        <div className="p-12 md:p-24 max-w-2xl">
          ...
          <div>
            ...
            <Typography className="mb-16" component="p">
              ...
              <b>helper classes</b> for fast development, ease of use, globally
              access etc. So we have used both in components.
            </Typography>
            ...
            <Typography className="mb-16" component="p">
              ...
              named '<b>tailwind.js</b>' under the root of Fuse React.
            </Typography>
          </div>
        </div>
      }
