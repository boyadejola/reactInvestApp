  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        icons to change the size of the checkboxes.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        A checkbox input can only have two states in a form: checked or
        unchecked. It either submits its value or doesn&#39;t. Visually, there
        are <strong>three</strong> states a checkbox can be in: checked,
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ When indeterminate is set, the value of the <code>checked</code>{" "}
          prop only impacts the form submitted values. It has no accessibility
          or UX implications.
        </Typography>
      </blockquote>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
