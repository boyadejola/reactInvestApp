  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        creates visual consistency between layouts while allowing flexibility
        across a wide variety of designs. Material Design&#39;s responsive UI is
        based on a 12-column grid layout.
      </Typography>
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ The <code>Grid</code> component shouldn&#39;t be confused with a
          data grid; it is closer to a layout grid. For a data grid head to{" "}
      ...
      <ul>
        ...
        <li>
          Integer values can be given to each breakpoint, indicating how many of
          the 12 available columns are occupied by the component when the
          viewport width satisfies the{" "}
          <a href="/customization/breakpoints/#default-breakpoints">
            breakpoint contraints
          </a>
          .
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        If you are <strong>new to or unfamiliar with flexbox</strong>, we
      ...
      <Typography className="mb-40" component="div">
        ...
        than it (unless overridden, as you can read later in this page). For
        example, <code>{`xs={12}`}</code> sizes a component to occupy the whole
      ...
      <Typography className="mb-40" component="div">
        For example, <code>{`xs={12} sm={6}`}</code> sizes a component to occupy
        half of the viewport width (6 columns) when viewport width is{" "}
        <a href="/customization/breakpoints/#default-breakpoints">
          600 or more pixels
        </a>
      ...
      <Typography className="mb-40" component="div">
        To control space between children, use the <code>spacing</code> prop.
        The spacing value can be any positive number, including decimals and any
        string. The prop is converted into a CSS property using the{" "}
      ...
      <Typography className="mb-40" component="div">
        The <code>rowSpacing</code> and <code>columnSpacing</code> props allow
        for specifying the row and column gaps independently. It&#39;s similar
        to the <code>row-gap</code> and <code>column-gap</code> properties of{" "}
      ...
      <Typography className="mb-40" component="div">
        You can switch the props&#39; value based on the active breakpoint. For
        instance, we can implement the{" "}
        <a href="https://material.io/design/layout/responsive-layout-grid.html">
          &quot;recommended&quot;
        </a>{" "}
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ When using a responsive <code>columns</code> prop, each grid item
          needs its corresponding breakpoint. For instance, this is not working.
          The grid item misses the value for <code>md</code>:
        </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Below is an interactive demo that lets you explore the visual results of
      ...
      <Typography className="mb-40" component="div">
        The Auto-layout makes the <em>items</em> equitably share the available
        space. That also means you can set the width of one <em>item</em> and
        the others will automatically resize around it.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Set one of the size breakpoint props to <code>'auto'</code> instead of{" "}
        <code>true</code> / a <code>number</code> to size a column based on the
      ...
      <Typography className="mb-40" component="div">
        The following demo doesn&#39;t follow the Material Design guidelines,
        but illustrates how the grid can be used to build complex layouts.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>container</code> and <code>item</code> props are two
        independent booleans; they can be combined to allow a Grid component to
        be both a flex container and child.
      </Typography>
      <blockquote>
        <Typography className="mb-40" component="div">
          A flex <strong>container</strong> is the box generated by an element
          with a computed display of <code>flex</code> or{" "}
          <code>inline-flex</code>. In-flow children of a flex container are
          called flex <strong>items</strong> and are laid out using the flex
          layout model.
        </Typography>
      </blockquote>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        ⚠️ Defining an explicit width to a Grid element that is flex container,
        flex item, and has spacing at the same time lead to unexpected behavior,
        avoid doing it:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        You can change the default number of columns (12) with the{" "}
      ...
      <Typography className="mb-40" component="div">
        The spacing between items is implemented with a negative margin. This
        might lead to unexpected behaviors. For instance, to apply a background
        color, you need to apply <code>display: flex;</code> to the parent.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        white-space: nowrap;
      </Typography>
      <Typography className="mb-40" component="div">
        The initial setting on flex items is <code>min-width: auto</code>.
        It&#39;s causing a positioning conflict when the children is using{" "}
        <code>white-space: nowrap;</code>. You can experience the issue with:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>min-width: 0</code>. In practice, you can set the{" "}
        <code>zeroMinWidth</code> prop:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        The <code>xs</code>, <code>sm</code>, <code>md</code>, <code>lg</code>,
        and <code>xl</code> props are <strong>not supported</strong> within{" "}
        <code>direction='column'</code> and{" "}
        <code>direction='column-reverse'</code> containers.
      </Typography>
      <Typography className="mb-40" component="div">
        They define the number of grids the component will use for a given
        breakpoint. They are intended to control <strong>width</strong> using{" "}
        <code>flex-basis</code> in <code>row</code> containers but they will
        impact height in <code>column</code> containers. If used, these props
        may have undesirable effects on the height of the <code>Grid</code> item
        elements.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        CSS Grid Layout
      ...
      <Typography className="mb-40" component="div">
        The <code>Grid</code> component is using CSS flexbox internally. But as
        seen below, you can easily use <a href="/system/grid/">the system</a>{" "}
        and CSS Grid to layout your pages.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        properties. You can use them as props directly on the component. For
        instance, a padding:
      </Typography>
