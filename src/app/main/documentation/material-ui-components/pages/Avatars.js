  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>src</code> or <code>srcSet</code> to the component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        You can use different background colors for the avatar. The following
        demo generates the color based on the name of the person.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        to an alternative in the following order:
      </Typography>
      <ul>
