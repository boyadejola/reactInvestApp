...
function AlertDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        You can use the <code>AlertTitle</code> component to display a formatted
      ...
      <Typography className="mb-40" component="div">
        If an <code>onClose</code> callback is provided and no{" "}
        <code>action</code> prop is set, a close icon is displayed. The{" "}
        <code>action</code> prop can be used to provide an alternative action,
        for example using a Button or IconButton.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        You can use a{" "}
        <a href="/components/transitions/">transition component</a> such as{" "}
      ...
      <Typography className="mb-40" component="div">
        The <code>icon</code> prop allows you to add an icon to the beginning of
        the alert component. This will override the default icon for the
        specified severity.
      </Typography>
      <Typography className="mb-40" component="div">
        You can change the default severity to icon mapping with the{" "}
        <code>iconMapping</code> prop. This can be defined globally using{" "}
        <a href="/customization/theme-components/#default-props">
          theme customization
        </a>
        .
      </Typography>
      <Typography className="mb-40" component="div">
        Setting the icon prop to <code>false</code> will remove the icon
        altogether.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/components/snackbars/#customized-snackbars">
          display a toast
        </a>{" "}
        with the Alert.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        The <code>color</code> prop will override the default color for the
        specified severity.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        automatically announced by most screen readers. At this time, screen
        readers do not inform users of alerts that are present when the page
        loads.
      </Typography>
      <Typography className="mb-40" component="div">
        ...
        from the content itself (for example the visible text), or is included
        through alternative means, such as additional hidden text.
      </Typography>
      <Typography className="mb-40" component="div">
        Actions must have a tab index of 0 so that they can be reached by
        keyboard-only users.
      </Typography>
    </>
  );
