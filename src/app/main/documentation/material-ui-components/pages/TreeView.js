...
function TreeViewDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        While the <code>TreeView</code>/<code>TreeItem</code> component API
        maximizes flexibility, an extra step is needed to handle a rich object.
      </Typography>
      <Typography className="mb-40" component="div">
...
`}
      ...
      <Typography className="mb-40" component="div">
        You can use the <code>ContentComponent</code> prop and the{" "}
        <code>useTreeItem</code> hook to further customize the behavior of the
        TreeItem.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>disabledItemsFocusable</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        If it is false:
      </Typography>
      <ul>
        <li>
          Arrow keys will not focus disabled items and, the next non-disabled
          item will be focused.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>aria-labelledby</code> or <code>aria-label</code> to reference or
        provide a label on the TreeView, otherwise screen readers will announce
        it as &quot;tree&quot;, making it hard to understand the context of a
        specific tree item.
      </Typography>
    </>
  );
