...
function ClickAwayListenerDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        Notice that the component only accepts one child element. You can find a
        more advanced demo on the{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        to render the dropdown into a new &quot;subtree&quot; outside of current
        DOM hierarchy.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        By default, the component responds to the trailing events (click + touch
        end). However, you can configure it to respond to the leading events
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ In this mode, only interactions on the scrollbar of the document is
          ignored.
        </Typography>
      </blockquote>
    </>
