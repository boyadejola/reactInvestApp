  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>marks</code> prop with <code>{`step={null}`}</code>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        an array of values to the <code>value</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>onChange</code> event handler. By default, when you move the
        pointer over a thumb while dragging another thumb, the active thumb will
        swap to the hovered thumb. You can disable this behavior with the{" "}
        <code>disableSwap</code> prop. If you want the range to shift when
        reaching minimum distance, you can utilize the <code>activeThumb</code>{" "}
      ...
      <Typography className="mb-40" component="div">
        <strong>WARNING</strong>: Chrome, Safari and newer Edge versions i.e.
        any browser based on WebKit exposes{" "}
        ...
        ). By applying <code>-webkit-appearance: slider-vertical;</code> the
        slider is exposed as vertical.
      </Typography>
      <Typography className="mb-40" component="div">
        However, by applying <code>-webkit-appearance: slider-vertical;</code>{" "}
        keyboard navigation for horizontal keys (
        ...
        ). Usually, up and right should increase and left and down should
        decrease the value. If you apply <code>-webkit-appearance</code> you
        could prevent keyboard navigation for horizontal arrow keys for a truly
        vertical slider. This might be less confusing to users compared to a
        change in direction.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        You can use the <code>scale</code> prop to represent the{" "}
        <code>value</code> on a different scale.
      </Typography>
      <Typography className="mb-40" component="div">
        In the following demo, the value <em>x</em> represents the value{" "}
        <em>2^x</em>. Increasing <em>x</em> by one increases the represented
        value by factor <em>2</em>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <ul>
        ...
        <li>
          ...
          required if the value matches the semantics of the label. You can
          change the name with the <code>getAriaValueText</code> or{" "}
