...
function ProgressDoc(props) {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>Determinate</strong> indicators display how long an operation
          will take.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        The progress components accept a value in the range 0 - 100. This
        simplifies things for screen-reader users, where these are the default
        min / max values. Sometimes, however, you might be working with a data
        source where the values fall outside this range. Here&#39;s how you can
        easily transform a value in any range to a scale of 0 - 100:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        to know around response time. The ripple effect of the{" "}
        <code>ButtonBase</code> component ensures that the user feels that the
        system is reacting instantaneously. Normally, no special feedback is
        necessary during delays of more than 0.1 but less than 1.0 second. After
        1.0 second, you can display a loader to keep user&#39;s flow of thought
        uninterrupted.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>CircularProgress</code> ring widths. You should run processor
        intensive operations in a web worker or by batch in order not to block
        the main rendering thread.
      </Typography>
      <Typography className="mb-40" component="div">
        {" "}
        src='/material-ui-static/images/progress/heavy-load.gif' alt='heavy
        load/>
      </Typography>
      <Typography className="mb-40" component="div">
        When it&#39;s not possible, you can leverage the{" "}
        <code>disableShrink</code> prop to mitigate the issue. See{" "}
        <a href="https://github.com/mui-org/material-ui/issues/10327">
          this issue
        </a>
        .
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        The <code>LinearProgress</code> uses a transition on the CSS transform
        property to provide a smooth update between different values. The
        default transition duration is 200ms. In the event a parent component
        updates the <code>value</code> prop too quickly, you will at least
        experience a 200ms delay between the re-render and the progress bar
        fully updated.
      </Typography>
      <Typography className="mb-40" component="div">
        If you need to perform 30 re-renders per second or more, we recommend
...
`}
      ...
      <Typography className="mb-40" component="div">
        The circular progress component animation on IE 11 is degraded. The
        stroke dash animation is not working (equivalent to{" "}
        <code>disableShrink</code>) and the circular animation wobbles. You can
        solve the latter with:
      </Typography>
