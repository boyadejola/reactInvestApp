  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        This component combines the date &amp; time pickers. It allows the user
        to select both date and time with the same control.
      </Typography>
      <Typography className="mb-40" component="div">
        Note that this component is the{" "}
        <a href="/components/date-picker/">DatePicker</a> and{" "}
        <a href="/components/time-picker/">TimePicker</a>
        component combined, so any of these components&#39; props can be passed
...
`}
      ...
      <Typography className="mb-40" component="div">
        Allows choosing date then time. There are 4 steps available (year, date,
        hour and minute), so tabs are required to visually distinguish date/time
        steps.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        The <code>DateTimePicker</code> component is designed and optimized for
        the device it runs on.
      </Typography>
      <ul>
        <li>
          The <code>MobileDateTimePicker</code> component works best for touch
          devices and small screens.
        </li>
        <li>
          The <code>DesktopDateTimePicker</code> component works best for mouse
          devices and large screens.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        By default, the <code>DateTimePicker</code> component renders the
      ...
      <ul>
        <li>
          by using <code>minDateTime</code>/<code>maxDateTime</code> its
          possible to restrict time selection to before or after a particular
          moment in time
        </li>
        <li>
          using <code>minTime</code>/<code>maxTime</code>, you can disable
          selecting times before or after a certain time each day respectively
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        <FuseExample
