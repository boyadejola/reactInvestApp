...
function CardsDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        By default, we use the combination of a <code>{`<div>`}</code> element
        and a <em>background image</em> to display the media. It can be
        problematic in some situations, for example, you might want to display a
        video or a responsive image. Use the <code>component</code> prop for
        these use cases:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ When <code>component='img'</code>, CardMedia relies on{" "}
          <code>object-fit</code> for centering the image. It&#39;s not
          supported by IE11.
        </Typography>
      </blockquote>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
      ...
      <Typography className="mb-40" component="div">
        Often a card allow users to interact with the entirety of its surface to
        trigger its main action, be it an expansion, a link to another screen or
        some other behavior. The action area of the card can be specified by
        wrapping its contents in a <code>CardActionArea</code> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        A card can also offer supplemental actions which should stand detached
        from the main action area in order to avoid event overlap.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
