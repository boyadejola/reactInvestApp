  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        has a limited set of type sizes that work well together along with the
        layout grid.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        The <em>Roboto</em> font will <strong>not</strong> be automatically
        loaded by MUI. You are responsible for loading any fonts used in your
        application. Roboto Font has a few easy ways to get started. For more
        advanced configuration, check out
      ...
      <Typography className="mb-40" component="div">
        Shown below is a sample link markup used to load the Roboto font from a
        CDN:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        by typing the below command in your terminal:
      </Typography>
      <Typography className="mb-40" component="div">
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>Typography</code> component. Hopefully, you might be able to take
        advantage of the{" "}
      ...
      <Typography className="mb-40" component="div">
        The Typography component uses the <code>variantMapping</code> prop to
...
`}
      ...
      <Typography className="mb-40" component="div">
        In addition to using the default typography variants, you can add custom
        ones, or disable any you don&#39;t need. See the{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        properties. You can use them as prop directly on the component. For
        instance, a margin-top:
      </Typography>
...
`}
      ...
      <ul>
        <li>
          ...
          background, check out the minimum recommended{" "}
        ...
        <li>
          ...
          <a href="/customization/typography/#font-size">
            relative units (rem)
          </a>{" "}
        ...
        <li>
          ...
          <a href="#changing-the-semantic-element">
