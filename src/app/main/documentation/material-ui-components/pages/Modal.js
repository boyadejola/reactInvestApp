  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The component renders its <code>children</code> node in front of a
        backdrop component. The <code>Modal</code> offers important features:
      </Typography>
      <ul>
        <li>
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          <strong>Terminology note</strong>. The term &quot;modal&quot; is
          sometimes used to mean &quot;dialog&quot;, but this is a misnomer. A
          modal window describes parts of a UI. An element is considered modal
          if{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/components/dialogs/">Dialog</a> component rather than directly
        using Modal. Modal is a lower-level construct that is leveraged by the
      ...
      <ul>
        <li>
          📦{" "}
          <a href="https://bundlephobia.com/result?p=@mui/core@latest">
            4.7 kB gzipped
          </a>
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        The modal also comes with an unstyled version. It&#39;s ideal for doing
...
`}
      ...
      <Typography className="mb-40" component="div">
        Modals can be nested, for example a select within a dialog, but stacking
        of more than two modals, or any two modals with a backdrop is
        discouraged.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <ul>
        ...
        <li>
          Have an <code>in</code> prop. This corresponds to the open/close
          state.
        </li>
        <li>
          Call the <code>onEnter</code> callback prop when the enter transition
          starts.
        </li>
        <li>
          Call the <code>onExited</code> callback prop when the exit transition
          is completed. These two callbacks allow the modal to unmount the child
          content when closed and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        ...
        content available to search engines or render expensive component trees
        inside your modal while optimizing for interaction responsiveness it
        might be a good idea to change this default behavior by enabling the{" "}
...
`}
      ...
      <Typography className="mb-40" component="div">
        As with any performance optimization, this is not a silver bullet. Be
        sure to identify bottlenecks first, and then try out these optimization
        strategies.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Server-side modal
      ...
      <Typography className="mb-40" component="div">
        React{" "}
        <a href="https://github.com/facebook/react/issues/13097">
          doesn&#39;t support
        </a>{" "}
        the{" "}
        ...
        API on the server. In order to display the modal, you need to disable
        the portal feature with the <code>disablePortal</code> prop:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The modal moves the focus back to the body of the component if the focus
        tries to escape it.
      </Typography>
      <Typography className="mb-40" component="div">
        This is done for accessibility purposes. However, it might create
        issues. In the event the users need to interact with another part of the
        page, e.g. with a chatbot window, you can disable the behavior:
      </Typography>
...
`}
      ...
      <ul>
        <li>
          <Typography className="mb-40" component="div">
            Be sure to add <code>aria-labelledby='id...'</code>, referencing the
            modal title, to the <code>Modal</code>. Additionally, you may give a
            description of your modal with the{" "}
...
`}
        ...
        <li>
          <Typography className="mb-40" component="div">
            ...
            can help you set the initial focus on the most relevant element,
            based on your modal content.
          </Typography>
        </li>
        <li>
          <Typography className="mb-40" component="div">
            Keep in mind that a &quot;modal window&quot; overlays on either the
            primary window or another modal window. Windows under a modal are{" "}
            <strong>inert</strong>. That is, users cannot interact with content
            outside an active modal window. This might create{" "}
