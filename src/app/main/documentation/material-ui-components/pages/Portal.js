  ...
  return (
    <>
      ...
      <Typography className="description">
        ...
        of current DOM hierarchy.
      </Typography>

      <Typography className="mb-40" component="div">
        The children of the portal component will be appended to the{" "}
        <code>container</code> specified. The component is used internally by
        the{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        API on the server. You have to wait for the client-side hydration to see
        the children.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Unstyled
