  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        A Dialog is a type of <a href="/components/modal/">modal</a> window that
        appears in front of app content to provide critical information or ask
        for a decision. Dialogs disable all app functionality when they appear,
        and remain on screen until confirmed, dismissed, or a required action
        has been taken.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <ul>
        ...
        <li>
          Touching outside of the dialog, or pressing Back, cancels the action
      ...
      <Typography className="mb-40" component="div">
        ...
        choices based on the title and button text alone.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        You can set a dialog maximum width by using the <code>maxWidth</code>{" "}
        enumerable in combination with the <code>fullWidth</code> boolean. When
        the <code>fullWidth</code> prop is true, the dialog will adapt based on
        the <code>maxWidth</code> value.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        . To do so, you can pass the imported <code>Draggable</code> component
        as the <code>PaperComponent</code> of the <code>Dialog</code> component.
      ...
      <ul>
        <li>
          <code>scroll=paper</code> the content of the dialog scrolls within the
          paper element.
        </li>
        <li>
          <code>scroll=body</code> the content of the dialog scrolls within the
          body element.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        Follow the{" "}
        <a href="/components/modal/#limitations">Modal limitations section</a>.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Accessibility
      </Typography>
      <Typography className="mb-40" component="div">
        Follow the{" "}
        <a href="/components/modal/#accessibility">
