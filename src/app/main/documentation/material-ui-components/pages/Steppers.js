    ...
    <>
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ...
          <a href="https://material.io/">Material Design guidelines</a>, but MUI
      ...
      <Typography className="mb-40" component="div">
        Horizontal steppers are ideal when the contents of one step depend on an
        earlier step.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        The <code>Stepper</code> can be controlled by passing the current step
        index (zero-based) as the <code>activeStep</code> prop.{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>optional</code> prop on the second <code>Step</code> component.
        ...
        active step index has gone beyond the optional step, it&#39;s not
        actually complete.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Non-linear steppers allow the user to enter a multi-step flow at any
        point.
      </Typography>
      <Typography className="mb-40" component="div">
        ...
        based on the <code>activeStep</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        The use of the <code>StepButton</code> here demonstrates clickable step
        labels, as well as setting the <code>completed</code>
        flag. However because steps can be accessed in a non-linear fashion,
        it&#39;s up to your own implementation to determine when all steps are
        completed (or even if they need to be completed).
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>alternativeLabel</code> prop on the <code>Stepper</code>{" "}
        component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Vertical steppers are designed for narrow screen sizes. They are ideal
        for mobile. All the features of the horizontal stepper can be
        implemented.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        The content of a step is unmounted when closed. If you need to make the
        ...
        might be a good idea to keep the step mounted with:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        This component implements a compact stepper suitable for a mobile
        device. It has more limited functionality than the vertical stepper. See{" "}
      ...
      <Typography className="mb-40" component="div">
        The mobile stepper supports three variants to display progress through
        the available steps: text, dots, and progress.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Text
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        Use a progress bar when there are many steps, or if there are steps that
        need to be inserted during the process (based on responses to earlier
        steps).
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
