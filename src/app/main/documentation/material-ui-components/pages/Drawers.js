  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        Navigation drawers (or &quot;sidebars&quot;) provide access to
        destinations and app functionality, such as switching accounts. They can
        either be permanently on-screen or controlled by a navigation menu icon.
      </Typography>
      <Typography className="mb-40" component="div">
        <a href="https://material.io/components/sheets-side">Side sheets</a> are
      ...
      <Typography className="mb-40" component="div">
        The Drawer can be cancelled by clicking the overlay or pressing the Esc
        key. It closes when an item is selected, handled by controlling the{" "}
        <code>open</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        mobile devices won&#39;t be able to follow the fingers at 60 FPS. You
        can use the <code>disableBackdropTransition</code> prop to help.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <ul>
        <li>
          iOS is hosted on high-end devices. The backdrop transition can be
          enabled without dropping frames. The performance will be good enough.
        </li>
        <li>
          iOS has a &quot;swipe to go back&quot; feature that interferes with
          the discovery feature, so discovery has to be disabled.
        </li>
      </ul>
...
`}
      ...
      <Typography className="mb-40" component="div">
        You can configure the <code>SwipeableDrawer</code> to have a visible
        edge when closed.
      </Typography>
      <Typography className="mb-40" component="div">
        If you are on a desktop, you can toggle the drawer with the
      ...
      <Typography className="mb-40" component="div">
        To ensure a temporary drawer is not unmounted, specify the{" "}
        <code>ModalProps</code> prop like:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        More details in the{" "}
        <a href="/components/modal/#performance">Modal performance section</a>.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Responsive drawer
      </Typography>
      <Typography className="mb-40" component="div">
        You can use the <code>temporary</code> variant to display a drawer for
        small screens and <code>permanent</code> for a drawer for wider screens.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Persistent navigation drawers can toggle open or closed. The drawer sits
        on the same surface elevation as the content. It is closed by default
        and opens by selecting the menu icon, and stays open until closed by the
        user. The state of the drawer is remembered from action to action and
        session to session.
      </Typography>
      <Typography className="mb-40" component="div">
        When the drawer is outside of the page grid and opens, the drawer forces
        other content to change size and adapt to the smaller viewport.
      </Typography>
      <Typography className="mb-40" component="div">
        Persistent navigation drawers are acceptable for all sizes larger than
        mobile. They are not recommended for apps with multiple levels of
        hierarchy that require using an up arrow for navigation.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        Its resting state is as a mini-drawer at the same elevation as the
        content, clipped by the app bar. When expanded, it appears as the
        standard persistent navigation drawer.
      </Typography>
      <Typography className="mb-40" component="div">
        The mini variant is recommended for apps sections that need quick
      ...
      <Typography className="mb-40" component="div">
        ...
        edge, at the same elevation as the content or background. They cannot be
        closed.
      </Typography>
      <Typography className="mb-40" component="div">
        Permanent navigation drawers are the{" "}
        <strong>recommended default for desktop</strong>.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Full-height navigation
      </Typography>
      <Typography className="mb-40" component="div">
        Apps focused on information consumption that use a left-to-right
        hierarchy.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
