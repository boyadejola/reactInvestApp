  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        If more than six actions are needed, something other than a FAB should
        be used to present them.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>open</code>/<code>onOpen</code>/<code>onClose</code> props.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        You can provide an alternate icon for the closed and open states using
        the <code>icon</code> and <code>openIcon</code> props of the{" "}
      ...
      <Typography className="mb-40" component="div">
        The SpeedDialActions tooltips can be displayed persistently so that
        users don&#39;t have to long-press to see the tooltip on touch devices.
      </Typography>
      <Typography className="mb-40" component="div">
        It is enabled here across all devices for demo purposes, but in
        production it could use the <code>isTouch</code> logic to conditionally
        set the prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <ul>
        <li>
          You should provide an <code>ariaLabel</code> for the speed dial
          component.
        </li>
        <li>
          You should provide a <code>tooltipTitle</code> for each speed dial
          action.
        </li>
      </ul>
      <Typography className="text-16 mt-16 mb-10" component="h4">
      ...
      <ul>
        ...
        <li>
          ...
          <code>aria-describedby</code> attribute that references the associated
          tooltip.
        </li>
      </ul>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
      ...
      <ul>
        ...
        <li>
          The Space and Enter keys trigger the selected speed dial action, and
          toggle the speed dial open state.
        </li>
        <li>
          The cursor keys move focus to the next or previous speed dial action.
          (Note that any cursor direction can be used initially to open the
          speed dial. This enables the expected behavior for the actual or
          perceived orientation of the speed dial, for example for a screen
          reader user who perceives the speed dial as a drop-down menu.)
        </li>
        <li>
          The Escape key closes the speed dial and, if a speed dial action was
          focused, returns focus to the Fab.
        </li>
      </ul>
    </>
  );
