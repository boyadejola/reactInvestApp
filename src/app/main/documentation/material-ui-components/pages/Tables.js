  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        users can look for patterns and insights. They can be embedded in
        primary content, such as cards. They can include:
      </Typography>
      <ul>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>{`<table>`}</code> elements. This constraint makes building rich
        data tables challenging.
      </Typography>
      <Typography className="mb-40" component="div">
        The{" "}
        ...
        is designed for use-cases that are focused on handling large amounts of
        tabular data. While it comes with a more rigid structure, in exchange,
        you gain more powerful features.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        This example demonstrates the use of <code>Checkbox</code> and clickable
        rows for selection, with a custom <code>Toolbar</code>. It uses the{" "}
        <code>TableSortLabel</code> component to help style column headings.
      </Typography>
      <Typography className="mb-40" component="div">
        The Table has been given a fixed width to demonstrate horizontal
        scrolling. In order to prevent the pagination controls from scrolling,
        the TablePagination component is used outside of the Table. (The{" "}
        <a href="#custom-pagination-actions">
          &#39;Custom Table Pagination Action&#39; example
        </a>{" "}
      ...
      <Typography className="mb-40" component="div">
        It&#39;s possible to customize the options shown in the &quot;Rows per
        page&quot; select using the <code>rowsPerPageOptions</code> prop. You
        should either provide an array of:
      </Typography>
      <ul>
        <li>
          <Typography className="mb-40" component="div">
            <strong>numbers</strong>, each number will be used for the
            option&#39;s label and value.
          </Typography>
...
`}
        ...
        <li>
          <Typography className="mb-40" component="div">
            <strong>objects</strong>, the <code>value</code> and{" "}
            <code>label</code> keys will be used respectively for the value and
            label of the option (useful for language strings such as
            &#39;All&#39;).
          </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        The <code>ActionsComponent</code> prop of the{" "}
        <code>TablePagination</code> component allows the implementation of
        custom actions.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Here is an example of a table with scrollable rows and fixed column
        headers. It leverages the <code>stickyHeader</code> prop. (⚠️ no IE 11
        support)
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        You can group column headers by rendering multiple table rows inside a
        table head:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        with the <code>Table</code> component. It renders 200 rows and can
        easily handle more. Virtualization helps with performance issues.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        A caption functions like a heading for a table. Most screen readers
        announce the content of captions. Captions help users to find a table
