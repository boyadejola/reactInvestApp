...
function ButtonsDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The <code>Button</code> comes with three variants: text (default),
      ...
      <Typography className="mb-40" component="div">
        <a href="https://material.io/components/buttons#text-button">
          Text buttons
        </a>
      ...
      <Typography className="mb-40" component="div">
        <a href="https://material.io/components/buttons#contained-button">
          Contained buttons
        </a>
      ...
      <Typography className="mb-40" component="div">
        <a href="https://material.io/components/buttons#outlined-button">
          Outlined buttons
        </a>{" "}
      ...
      <Typography className="mb-40" component="div">
        All components accept an <code>onClick</code> handler that is applied to
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/guides/api/#native-properties">avoids</a> mentioning native
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/customization/palette/#adding-new-colors">
          Adding new colors
        </a>{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        without an HTTP round-trip to the server. The <code>ButtonBase</code>{" "}
        component provides the <code>component</code> prop to handle this use
        case. Here is a{" "}
      ...
      <Typography className="mb-40" component="div">
        The ButtonBase component sets <code>pointer-events: none;</code> on
        disabled buttons, which prevents the appearance of a disabled cursor.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <ol>
        <li>
          <strong>CSS only</strong>. You can remove the pointer-events style on
          the disabled state of the <code>{`<button>`}</code> element:
        </li>
      </ol>
...
`}
      ...
      <ul>
        <li>
          You should add <code>pointer-events: none;</code> back when you need
          to display{" "}
          <a href="/components/tooltips/#disabled-elements">
            tooltips on disabled elements
          </a>
          .
        </li>
        <li>
          The cursor won&#39;t change if you render something other than a
          button element, for instance, a link <code>{`<a>`}</code> element.
        </li>
      </ul>
      <ol start="2">
        <li>
...
`}
      ...
      <Typography className="mb-40" component="div">
        The button also comes with an unstyled version. It&#39;s ideal for doing
...
`}
      ...
      <Typography className="mb-40" component="div">
        By default, the <code>ButtonUnstyled</code> renders a native{" "}
        <code>button</code> element. You are free to override this by setting
        the <code>component</code> or <code>components.Root</code> prop. If a
        non-interactive element (such as a span) is provided this way, the{" "}
        <code>ButtonUnstyled</code> will take care of adding accessibility
        attributes.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Compare the attributes on the span with the button from the previous
        demo.
      </Typography>
      <Typography className="text-16 mt-16 mb-10" component="h4">
      ...
      <Typography className="mb-40" component="div">
        You are not limited to using HTML elements for the button structure. SVG
        elements, even with complex structure, are equally acceptable.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-40" component="div">
        If you need to use Button&#39;s functionality in another component, you
        can use the <code>useButton</code> hook. It returns props to be placed
        on a custom button element and fields representing the internal state of
        the button.
      </Typography>
      <Typography className="mb-40" component="div">
        The <code>useButton</code> hook requires the ref of the element
        it&#39;ll be used on. Additionally, you need to provide the{" "}
        <code>component</code> prop (unless you intend to use the plain{" "}
        <code>button</code>).
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
