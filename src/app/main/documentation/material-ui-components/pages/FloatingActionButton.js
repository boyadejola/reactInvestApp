  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        two types: regular, and extended.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        By default, the size is <code>large</code>. Use the <code>size</code>{" "}
      ...
      <Typography className="mb-40" component="div">
        The floating action button animates onto the screen as an expanding
      ...
      <Typography className="mb-40" component="div">
        ...
        use <code>enterDelay</code> to allow the outgoing Floating Action
