...
function SelectsDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        If you are looking for more advanced features, like combobox,
        multiselect, autocomplete, async or creatable support, head to the{" "}
      ...
      <Typography className="mb-40" component="div">
        The Select component is implemented as a custom <code>{`<input>`}</code>{" "}
        element of the <a href="/api/input-base/">InputBase</a>. It extends the{" "}
        <a href="/components/text-fields">text field components</a>{" "}
        sub-components, either the{" "}
        <a href="/api/outlined-input/">OutlinedInput</a>,{" "}
        <a href="/api/input/">Input</a>, or{" "}
        <a href="/api/filled-input/">FilledInput</a>, depending on the variant
        selected. It shares the same styles and many of the same props. Refer to
        the respective component&#39;s API page for details.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        ...
        including a label, input and help text. You can find an example with the
        select mode{" "}
      ...
      <Typography className="mb-40" component="div">
        The first step is to style the <code>InputBase</code> component. Once
        it&#39;s styled, you can either use it directly as a text field or
        provide it to the select <code>input</code> prop to have a{" "}
        <code>select</code> field. Notice that the <code>'standard'</code>{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        It&#39;s enabled with the <code>multiple</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        Like with the single selection, you can pull out the new value by
        accessing <code>event.target.value</code> in the <code>onChange</code>{" "}
      ...
      <Typography className="mb-40" component="div">
        While it&#39;s discouraged by the Material Design guidelines, you can
      ...
      <Typography className="mb-40" component="div">
        Display categories with the <code>ListSubheader</code> component or the
        native <code>{`<optgroup>`}</code> element.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        To properly label your <code>Select</code> input you need an extra
        element with an <code>id</code> that contains a label. That{" "}
        <code>id</code> needs to match the <code>labelId</code> of the{" "}
...
`}
      ...
      <Typography className="mb-40" component="div">
        Alternatively a <code>TextField</code> with an <code>id</code> and{" "}
        <code>label</code> creates the proper markup and ids for you:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        For a <a href="#native-select">native select</a>, you should mention a
        label by giving the value of the <code>id</code> attribute of the select
        element to the <code>InputLabel</code>
