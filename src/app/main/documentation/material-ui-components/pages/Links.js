  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/api/typography/">Typography</a> component, meaning that you
        can use its props.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        However, the Link component has some different default props than the
      ...
      <ul>
        ...
        <li>
          <code>variant='inherit'</code> as the link will, most of the time, be
      ...
      <Typography className="mb-40" component="div">
        The <code>underline</code> prop can be used to set the underline
        behavior. The default is <code>always</code>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="https://developers.google.com/web/tools/lighthouse/audits/noopener">
          recommended
        </a>{" "}
        to always set <code>rel='noopener'</code> or{" "}
        <code>rel='noreferrer'</code> when linking to third party content.
      </Typography>
      <ul>
        <li>
          <code>rel='noopener'</code> prevents the new page from being able to
          access the <code>window.opener</code> property and ensures it runs in
          a separate process. Without this, the target page can potentially
          redirect your page to a malicious URL.
        </li>
        <li>
          <code>rel='noreferrer'</code> has the same effect, but also prevents
          the <em>Referer</em> header from being sent to the new page. ⚠️
      ...
      <Typography className="mb-40" component="div">
        ...
        without an HTTP round-trip to the server. The <code>Link</code>{" "}
        component provides the <code>component</code> prop to handle this use
        case. Here is a <a href="/guides/routing/#link">more detailed guide</a>.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Accessibility
      </Typography>
      ...
      <ul>
        <li>
          ...
          like &quot;click here&quot; or &quot;go to&quot;. Instead, use{" "}
        ...
        <li>
          For the best user experience, links should stand out from the text on
          the page. For instance, you can keep the default{" "}
          <code>underline='always'</code> behavior.
        </li>
        <li>
