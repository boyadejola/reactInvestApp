    ...
    <>
      ...
      <ol>
        <li>
          ...
          name: <a href="#combo-box">combo box</a>.
        </li>
        <li>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>getOptionLabel</code> prop.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Playground
      </Typography>
      <Typography className="mb-40" component="div">
        Each of the following examples demonstrates one feature of the
      ...
      <ol>
        <li>
          the &quot;value&quot; state with the <code>value</code>/
          <code>onChange</code> props combination. This state represents the
          value selected by the user, for instance when pressing{" "}
          <kbd className="key">Enter</kbd>.
        </li>
        <li>
          the &quot;input value&quot; state with the <code>inputValue</code>/
          <code>onInputChange</code> props combination. This state represents
          the value displayed in the textbox.
        </li>
      </ol>
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ These two states are isolated, they should be controlled
          independently.
        </Typography>
      </blockquote>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        Set <code>freeSolo</code> to true so the textbox can contain any
        arbitrary value.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Search input
      ...
      <Typography className="mb-40" component="div">
        ...
        <strong>search input</strong> with suggestions, e.g. Google search or
        react-autowhatever.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        If you intend to use this mode for a <a href="#combo-box">combo box</a>{" "}
        like experience (an enhanced version of a select element) we recommend
        setting:
      </Typography>
      <ul>
        <li>
        ...
        <li>
          ...
          <kbd className="key">Home</kbd> and <kbd className="key">End</kbd>{" "}
          keys.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        You can group the options with the <code>groupBy</code> prop. If you do
        so, make sure that the options are also sorted with the same dimension
        that they are grouped by, otherwise you will notice duplicate headers.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>useAutocomplete()</code> hook is exposed. It accepts almost the
        same options as the Autocomplete component minus all the props related
        to the rendering of JSX. The Autocomplete component is built on this
        hook.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        The <code>useAutocomplete</code> hook is also reexported from
        @mui/material for convenience and backward compatibility.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Head to the <a href="#customization">customization</a> section for an
        example with the <code>Autocomplete</code> component instead of the
        hook.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
      ...
      <ul>
        <li>
          <a href="#load-on-open">Load on open</a>: it waits for the component
          to be interacted with to load the options.
        </li>
        <li>
          <a href="#search-as-you-type">Search as you type</a>: a new request is
          made for each keystroke.
        </li>
      </ul>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Load on open
      ...
      <Typography className="mb-40" component="div">
        If your logic is fetching new options on each keystroke and using the
        current value of the textbox to filter on the server, you may want to
        consider throttling requests.
      </Typography>
      <Typography className="mb-40" component="div">
        Additionally, you will need to disable the built-in filtering of the{" "}
        <code>Autocomplete</code> component by overriding the{" "}
        <code>filterOptions</code> prop:
      </Typography>
...
`}
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ Before you can start using the Google Maps JavaScript API, you must
      ...
      <Typography className="mb-40" component="div">
        In the event that you need to lock certain tag so that they can&#39;t be
        removed in the interface, you can set the chips disabled.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>renderInput</code> prop allows you to customize the rendered
        input. The first argument of this render prop contains props that you
        need to forward. Pay specific attention to the <code>ref</code> and{" "}
      ...
      <Typography className="mb-40" component="div">
        Head to the <a href="#customized-hook">Customized hook</a> section for a
        customization example with the <code>useAutocomplete</code> hook instead
        of the component.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Highlights
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="https://github.com/moroshko/autosuggest-highlight">
          autosuggest-highlight
        </a>
        , a small (1 kB) utility for highlighting text in autosuggest and
      ...
      <Typography className="mb-40" component="div">
        The component exposes a factory to create a filter method that can
        provided to the <code>filterOptions</code> prop. You can use it to
        change the default option filter behavior.
      </Typography>
...
`}
      ...
      <ul>
        <li>
          <code>config.ignoreAccents</code> (<em>bool</em> [optional]): Defaults
          to <code>true</code>. Remove diacritics.
        </li>
        <li>
          <code>config.ignoreCase</code> (<em>bool</em> [optional]): Defaults to{" "}
          <code>true</code>. Lowercase everything.
        </li>
        <li>
          <code>config.limit</code> (<em>number</em> [optional]): Default to
          null. Limit the number of suggested options to be shown. For example,
          if <code>config.limit</code> is <code>100</code>, only the first{" "}
          <code>100</code> matching options are shown. It can be useful if a lot
          of options match and virtualization wasn&#39;t set up.
        </li>
        <li>
          <code>config.matchFrom</code> (
          <em>&#39;any&#39; | &#39;start&#39;</em> [optional]): Defaults to{" "}
          <code>'any'</code>.
        </li>
        <li>
          <code>config.stringify</code> (<em>func</em> [optional]): Controls how
          an option is converted into a string so that it can be matched against
          the input text fragment.
        </li>
        <li>
          <code>config.trim</code> (<em>bool</em> [optional]): Defaults to{" "}
          <code>false</code>. Remove trailing spaces.
        </li>
      </ul>
      <Typography className="text-16 mt-16 mb-10" component="h4">
        Returns
      ...
      <Typography className="mb-40" component="div">
        <code>filterOptions</code>: the returned filter method can be provided
        directly to the <code>filterOptions</code> prop of the{" "}
        <code>Autocomplete</code> component, or the parameter of the same name
        for the hook.
      </Typography>
      <Typography className="mb-40" component="div">
...
`}
      ...
      <Typography className="mb-40" component="div">
        For richer filtering mechanisms, like fuzzy matching, it&#39;s
...
`}
      ...
      <Typography className="mb-40" component="div">
        Search within 10,000 randomly generated options. The list is virtualized
        thanks to{" "}
      ...
      <Typography className="mb-40" component="div">
        If you would like to prevent the default key handler behavior, you can
        set the event&#39;s <code>defaultMuiPrevented</code> property to{" "}
        <code>true</code>:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Browsers have heuristics to help the user fill in form inputs. However,
        this can harm the UX of the component.
      </Typography>
      <Typography className="mb-40" component="div">
        By default, the component disables the input{" "}
        <strong>autocomplete</strong> feature (remembering what the user has
        typed for a given field in a previous session) with the{" "}
        <code>autoComplete='off'</code> attribute. Google Chrome does not
        currently support this attribute setting (
        <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=587466">
          Issue 587466
        </a>
        ). A possible workaround is to remove the <code>id</code> to have the
        component generate a random one.
      </Typography>
      <Typography className="mb-40" component="div">
        In addition to remembering past entered values, the browser might also
        propose <strong>autofill</strong> suggestions (saved login, address, or
        payment details). In the event you want the avoid autofill, you can try
        the following:
      </Typography>
      <ul>
        <li>
          <Typography className="mb-40" component="div">
            Name the input without leaking any information the browser can use.
            e.g. <code>id='field1'</code> instead of <code>id='country'</code>.
            If you leave the id empty, the component uses a random id.
          </Typography>
        </li>
        <li>
          <Typography className="mb-40" component="div">
            Set <code>autoComplete='new-password'</code> (some browsers will
            suggest a strong password for inputs with this attribute setting):
          </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        VoiceOver on iOS Safari doesn&#39;t support the <code>aria-owns</code>{" "}
        attribute very well. You can work around the issue with the{" "}
      ...
      <Typography className="mb-40" component="div">
        If you provide a custom <code>ListboxComponent</code> prop, you need to
        make sure that the intended scroll container has the <code>role</code>{" "}
        attribute set to <code>listbox</code>. This ensures the correct behavior
        of the scroll, for example when using the keyboard to navigate.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Accessibility
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        We encourage the usage of a label for the textbox. The component
        implements the WAI-ARIA authoring practices.
      </Typography>
    </>
  );
}
