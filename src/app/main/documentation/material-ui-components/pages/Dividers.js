...
function DividersDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The divider renders as an <code>{`<hr>`}</code> by default. You can save
        rendering this DOM element by using the <code>divider</code> prop on the{" "}
        <code>ListItem</code> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>{`<li>`}</code> to match the HTML5 specification. The examples
        below show two ways of achieving this.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Inset dividers
      </Typography>
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          Note the use of the <code>flexItem</code> prop to accommodate for the
          flex container.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-40" component="div">
        You can also render a vertical divider with{" "}
        <code>variant='middle'</code>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
