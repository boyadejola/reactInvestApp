...
function TooltipsDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The <code>Tooltip</code> has 12 <strong>placements</strong> choice. They
        don&#39;t have directional arrows; instead, they rely on motion
      ...
      <Typography className="mb-40" component="div">
        You can use the <code>arrow</code> prop to give your tooltip an arrow
      ...
      <Typography className="mb-40" component="div">
        ...
        the child is a custom React element, you need to make sure that it
        spreads its props to the underlying DOM element.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/guides/composition/#wrapping-components">
          wrapping components
        </a>{" "}
        guide.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>leaveDelay</code> is expired. You can disable this behavior (thus
        failing the success criterion which is required to reach level AA) by
      ...
      <Typography className="mb-40" component="div">
        By default disabled elements like <code>{`<button>`}</code> do not
        trigger user interactions so a <code>Tooltip</code> will not activate on
        normal events like hover. To accommodate disabled elements, add a simple
        wrapper element, such as a <code>span</code>.
      </Typography>
      <blockquote>
        <Typography className="mb-40" component="div">
          ⚠️ In order to work with Safari, you need at least one display block
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          If you&#39;re not wrapping a MUI component that inherits from{" "}
          <code>ButtonBase</code>, for instance, a native{" "}
          <code>{`<button>`}</code> element, you should also add the CSS
          property <em>pointer-events: none;</em> to your element when disabled:
        </Typography>
      </blockquote>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>anchorEl</code> prop: The value of the <code>anchorEl</code> prop
        can be a reference to a fake DOM element. You need to create an object
        shaped like the{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        the <code>enterDelay</code> and <code>leaveDelay</code> props, as shown
        in the Controlled Tooltips demo above.
      </Typography>
      <Typography className="mb-40" component="div">
        ...
        with the <code>disableTouchListener</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        different from <code>title</code> which can either label{" "}
        <strong>or</strong> describe its child depending on whether the child
...
`}
      ...
      <Typography className="mb-40" component="div">
        the <code>title</code> acts as an accessible description. If you want
        the tooltip to act as an accessible description you can pass{" "}
        <code>describeChild</code>. Note that you shouldn&#39;t use{" "}
        <code>describeChild</code> if the tooltip provides the only visual
        label. Otherwise, the child would have no accessible name and the
        tooltip would violate{" "}
