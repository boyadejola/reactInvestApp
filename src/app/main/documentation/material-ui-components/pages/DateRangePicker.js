    ...
    <>
      ...
      <blockquote>
        <Typography className="mb-40" component="div">
          ...
          <br />
          <br />
          The date range picker is intended for MUI X Pro, a commercial set of
          advanced components built on top of the community edition (MIT
          license).
          <br />
          <br />
          This paid extension will include more advanced components (rich data
          grid, date range picker, tree view drag &amp; drop, etc.).{" "}
          <a href="https://material-ui.com/store/items/material-ui-pro/">
            Early access
          </a>{" "}
          starts at an affordable price.
        </Typography>
      </blockquote>
      <Typography className="mb-40" component="div">
...
`}
      ...
      <Typography className="mb-40" component="div">
        Note that you can pass almost any prop from{" "}
        <a href="/api/date-picker/">DatePicker</a>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        It&#39;s possible to render any picker inline. This will enable building
      ...
      <Typography className="mb-40" component="div">
        The date range picker component is designed to be optimized for the
        device it runs on.
      </Typography>
      <ul>
        <li>
          The <code>MobileDateRangePicker</code> component works best for touch
          devices and small screens.
        </li>
        <li>
          The <code>DesktopDateRangePicker</code> component works best for mouse
          devices and large screens.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        By default, the <code>DateRangePicker</code> component renders the
      ...
      <Typography className="mb-40" component="div">
        You can customize the rendered input with the <code>renderInput</code>{" "}
        prop. For <code>DateRangePicker</code> it takes <strong>2</strong>{" "}
        parameters – for start and end input respectively. If you need to render
        custom inputs make sure to spread <code>ref</code> and{" "}
        <code>inputProps</code> correctly to the input components.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        function prop. You can take advantage of the internal{" "}
        <a href="/api/date-range-picker-day/">DateRangePickerDay</a> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
