...
function ChipsDoc(props) {
  return (
    <>
      ...
      <ul>
        <li>
          Chips with the <code>onClick</code> prop defined change appearance on
          focus, hover, and click.
        </li>
        <li>
          Chips with the <code>onDelete</code> prop defined will display a
          delete icon which changes appearance on hover.
        </li>
      </ul>
      ...
      <Typography className="mb-40" component="div">
        Use the <code>avatar</code> prop to added a avatar or use the{" "}
        <code>icon</code> prop to added a icon.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Avatar chip
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        An example of rendering multiple chips from an array of values. Deleting
        a chip removes it from the array. Note that since no
        <code>onClick</code> prop is defined, the <code>Chip</code> can be
      ...
      <Typography className="mb-40" component="div">
        ...
        When the Chip is focused (e.g. when tabbing) releasing (
        <code>keyup</code> event) <code>Backspace</code> or <code>Delete</code>{" "}
        will call the <code>onDelete</code> handler while releasing{" "}
