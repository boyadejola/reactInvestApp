  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        Image lists represent a collection of items in a repeated pattern. They
        help improve the visual comprehension of the content they hold.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        Masonry image lists use dynamically sized container heights that reflect
        the aspect ratio of each image. This image list is best used for
      ...
      <Typography className="mb-40" component="div">
        This example demonstrates the use of the <code>ImageListItemBar</code>{" "}
        to add an overlay to each item. The overlay can accommodate a{" "}
        <code>title</code>, <code>subtitle</code> and secondary action - in this
      ...
      <Typography className="mb-40" component="div">
        In this example the items have a customized titlebar, positioned at the
        top and with a custom gradient <code>titleBackground</code>. The
        secondary action <code>IconButton</code> is positioned on the left. The{" "}
        <code>gap</code> prop is used to adjust the gap between items.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
