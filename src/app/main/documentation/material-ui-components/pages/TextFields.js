  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        including a label, input, and help text. It comes with three variants:
      ...
      <Typography className="mb-40" component="div">
        <strong>Note:</strong> The standard variant of the{" "}
        <code>TextField</code> is no longer documented in the{" "}
        <a href="https://material.io/">Material Design guidelines</a>(
      ...
      <Typography className="mb-40" component="div">
        Standard form attributes are supported e.g. <code>required</code>,{" "}
        <code>disabled</code>, <code>type</code>, etc. as well as a{" "}
        <code>helperText</code> which is used to give context about a
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>helperText</code> prop can then be used to provide feedback to the
      ...
      <Typography className="mb-40" component="div">
        ...
        element. Unless the <code>rows</code> prop is set, the height of the
        text field dynamically matches its content (using{" "}
        <a href="/components/textarea-autosize/">TextareaAutosize</a>). You can
        use the <code>minRows</code> and <code>maxRows</code> props to bound it.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The main way is with an <code>InputAdornment</code>. This can be used to
        add a prefix, a suffix, or an action to an input. For instance, you can
        use an icon button to hide or reveal the password.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>filled</code> variant input height can be further reduced by
        rendering the label outside of it.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>margin</code> prop can be used to alter the vertical spacing
        of the text field. Using <code>none</code> (default) doesn&#39;t apply
        margins to the <code>FormControl</code> whereas <code>dense</code> and{" "}
        <code>normal</code> do.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        <code>fullWidth</code> can be used to make the input take up the full
      ...
      <Typography className="mb-40" component="div">
        ...
        missing from the <code>TextField</code> component. This is on purpose.
        The component takes care of the most used properties. Then, it&#39;s up
        to the user to use the underlying component shown in the following demo.
        Still, you can use <code>inputProps</code> (and <code>InputProps</code>,{" "}
        <code>InputLabelProps</code> properties) if you want to avoid some
        boilerplate.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        The <code>color</code> prop changes the highlight color of the text
        field when focused.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        For advanced customization use cases, a <code>useFormControl()</code>{" "}
        hook is exposed. This hook returns the context value of the parent{" "}
        <code>FormControl</code> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <strong>API</strong>
      </Typography>
...
`}
      ...
      <ul>
        <li>
          <code>value.adornedStart</code> (<em>bool</em>): Indicate whether the
          child <code>Input</code> or <code>Select</code> component has a start
          adornment.
        </li>
        <li>
          <code>value.setAdornedStart</code> (<em>func</em>): Setter function
          for <code>adornedStart</code> state value.
        </li>
        <li>
          <code>value.color</code> (<em>string</em>): The theme color is being
          used, inherited from <code>FormControl</code> <code>color</code> prop
          .
        </li>
        <li>
          <code>value.disabled</code> (<em>bool</em>): Indicate whether the
          component is being displayed in a disabled state, inherited from{" "}
          <code>FormControl</code> <code>disabled</code> prop.
        </li>
        <li>
          <code>value.error</code> (<em>bool</em>): Indicate whether the
          component is being displayed in an error state, inherited from{" "}
          <code>FormControl</code> <code>error</code> prop
        </li>
        <li>
          <code>value.filled</code> (<em>bool</em>): Indicate whether input is
          filled
        </li>
        <li>
          <code>value.focused</code> (<em>bool</em>): Indicate whether the
          component and its children are being displayed in a focused state
        </li>
        <li>
          <code>value.fullWidth</code> (<em>bool</em>): Indicate whether the
          component is taking up the full width of its container, inherited from{" "}
          <code>FormControl</code> <code>fullWidth</code> prop
        </li>
        <li>
          <code>value.hiddenLabel</code> (<em>bool</em>): Indicate whether the
          label is being hidden, inherited from <code>FormControl</code>{" "}
          <code>hiddenLabel</code> prop
        </li>
        <li>
          <code>value.required</code> (<em>bool</em>): Indicate whether the
          label is indicating that the input is required input, inherited from
          the <code>FormControl</code> <code>required</code> prop
        </li>
        <li>
          <code>value.size</code> (<em>string</em>): The size of the component,
          inherited from the <code>FormControl</code> <code>size</code> prop
        </li>
        <li>
          <code>value.variant</code> (<em>string</em>): The variant is being
          used by the <code>FormControl</code> component and its children,
          inherited from <code>FormControl</code> <code>variant</code> prop
        </li>
        <li>
          <code>value.onBlur</code> (<em>func</em>): Should be called when the
          input is blurred
        </li>
        <li>
          <code>value.onFocus</code> (<em>func</em>): Should be called when the
          input is focused
        </li>
        <li>
          <code>value.onEmpty</code> (<em>func</em>): Should be called when the
          input is emptied
        </li>
        <li>
          <code>value.onFilled</code> (<em>func</em>): Should be called when the
          input is filled
        </li>
      </ul>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        ...
        &quot;shrink&quot; state (number input, datetime input, Stripe input).
      ...
      <Typography className="mb-40" component="div">
        To workaround the issue, you can force the &quot;shrink&quot; state of
        the label.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        For number validation, one viable alternative is to use the default
        input type=&quot;text&quot; with the <em>pattern</em> attribute, for
        example:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="https://github.com/mui-org/material-ui/issues/19154">
      ...
      <Typography className="mb-40" component="div">
        ...
        provide a custom implementation of the <code>{`<input>`}</code> element
        with the <code>inputComponent</code> property.
      </Typography>
      <Typography className="mb-40" component="div">
        The following demo uses the{" "}
        <a href="https://github.com/uNmAnNeR/imaskjs">react-imask</a> and{" "}
        <a href="https://github.com/s-yadav/react-number-format">
          react-number-format
        </a>{" "}
        libraries. The same concept could be applied to{" "}
        <a href="https://github.com/mui-org/material-ui/issues/16037">
...
`}
      ...
      <ul>
        <li>
          If you are using the <code>TextField</code> component, you just have
          to provide a unique <code>id</code>.
        </li>
...
`}
      ...
      <ul>
        <li>
          <a href="https://react-hook-form.com/">react-hook-form</a>: React hook
          for form validation.
        </li>
        <li>
          <a href="https://github.com/stackworx/formik-material-ui">
            formik-material-ui
          </a>
          : Bindings for using MUI with{" "}
          <a href="https://jaredpalmer.com/formik">formik</a>.
        </li>
        <li>
          <a href="https://github.com/erikras/redux-form-material-ui">
        ...
        <li>
          <a href="https://github.com/lookfirst/mui-rff">mui-rff</a>: Bindings
          for using MUI with{" "}
      ...
      <Typography className="mb-40" component="div">
        For advanced customization scenarios, you can use the unstyled
        primitives.
      </Typography>
      <Typography className="mb-40" component="div">
        The basic building blocks are the <code>InputUnstyled</code> component
        and the <code>useInput</code> hook.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Unstyled component
      </Typography>
      <Typography className="mb-40" component="div">
        The <code>InputUnstyled</code> component wraps the native{" "}
        <code>input</code> or <code>textarea</code> element. You can,
        optionally, provide a custom component to be rendered instead.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>useInput</code> hook is the headless version of the{" "}
        <code>InputUnstyled</code> component. Use it for even greater control
