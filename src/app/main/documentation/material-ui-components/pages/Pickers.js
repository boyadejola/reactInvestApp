...
function PickersDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        You need to provide a date-library that is used by the pickers by
        setting the <code>dateAdapter</code> to an adapter of your choosing.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        First you have to install the adapter package for the date-library you
        want to use:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Native date (<code>type='date'</code>), time (<code>type='time'</code>)
        and date&amp;time (<code>type='datetime-local'</code>) pickers.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
