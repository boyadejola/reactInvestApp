  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          Improve the time-to-first paint on the client by only rendering above
          the fold.
        </li>
        ...
        <li>
          Improve the time-to-interactive by only rendering what&#39;s important
          (with the <code>defer</code> property).
        </li>
      </ul>
      ...
      <Typography className="mb-40" component="div">
        At its core, the NoSsr component&#39;s purpose is to{" "}
        <strong>defer rendering</strong>. As it&#39;s illustrated in the
        previous demo, you can use it to defer the rendering from the server to
        the client.
      </Typography>
      <Typography className="mb-40" component="div">
        But you can also use it to defer the rendering within the client itself.
        You can <strong>wait a screen frame</strong> with the <code>defer</code>{" "}
        property to render the children. React does{" "}
