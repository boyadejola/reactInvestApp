  ...
  return (
    <>
      ...
      <Typography className="description">
        The Stack component manages layout of immediate children along the
        vertical or horizontal axis with optional spacing and/or dividers
        between each child.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/components/grid/">Grid</a> that handles two-dimensional
        layouts. The default direction is <code>column</code> which stacks
        children vertically.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        The prop is converted into a CSS property using the{" "}
      ...
      <Typography className="mb-40" component="div">
        By default, <code>Stack</code> arranges items vertically in a{" "}
        <code>column</code>. However, the <code>direction</code> prop can be
        used to position items horizontally in a <code>row</code> as well.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        child. This works particularly well with the{" "}
        <a href="/components/dividers/">Divider</a> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        You can switch the <code>direction</code> or <code>spacing</code> values
