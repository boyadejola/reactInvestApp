    ...
    <>
      ...
      <ul>
        <li>
          ...
          <a href="https://github.com/popperjs/popper-core">Popper.js</a>) for
          perfect positioning.
        </li>
        <li>
          💄 It&#39;s an alternative API to react-popper. It aims for
          simplicity.
        </li>
        <li>
        ...
        <li>
          ...
          to the body of the document to avoid rendering problems. You can
          disable this behavior with <code>disablePortal</code>.
        </li>
        <li>
        ...
        <li>
          Clicking away does not hide the <code>Popper</code> component. If you
          need this behavior, you can use{" "}
          <a href="/components/click-away-listener/">
            <code>ClickAwayListener</code>
          </a>{" "}
          - see the example in the{" "}
          <a href="/components/menus/#menulist-composition">
            menu documentation section
          </a>
          .
        </li>
        <li>
          The <code>anchorEl</code> is passed as the reference object to create
          a new <code>Popper.js</code> instance.
        </li>
      </ul>
      ...
      <Typography className="mb-40" component="div">
        The open/close state of the popper can be animated with a render prop
        child and a transition component. This component should respect the
      ...
      <ul>
        ...
        <li>
          ...
          is completed. These two callbacks allow the popper to unmount the
          child content when closed and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        The value of the <code>anchorEl</code> prop can be a reference to a fake
