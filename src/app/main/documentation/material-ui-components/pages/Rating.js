...
function RatingDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The rating can display any float number with the <code>value</code>{" "}
        prop. Use the <code>precision</code> prop to define the minimum
        increment value change allowed.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        rating value. The demo uses the <code>onChangeActive</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>highlightSelectedOnly</code> to restore the natural behavior.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <ul>
        <li>
          ...
          default. Be sure to provide a value for the <code>name</code> prop
          that is unique to the parent form.
        </li>
        <li>
          Labels for the radio buttons containing actual text (“1 Star”, “2
          Stars”, …). Be sure to provide a suitable function to the{" "}
          <code>getLabelText</code> prop when the page is in a language other
          than English. You can use the{" "}
          <a href="https://mui.com/guides/localization/">included locales</a>,
          or provide your own.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        The read only rating has a role of &quot;img&quot;, and an aria-label
        that describes the displayed rating.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Keyboard
      </Typography>
