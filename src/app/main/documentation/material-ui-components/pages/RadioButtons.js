  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        available options can be collapsed, consider using a dropdown menu
      ...
      <Typography className="mb-40" component="div">
        You can control the radio with the <code>value</code> and{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>FormControlLabel</code> component&#39;s{" "}
      ...
      <Typography className="mb-40" component="div">
        In general, radio buttons should have a value selected by default. If
        this is not the case, you can display an error if no value is selected
      ...
      <Typography className="mb-40" component="div">
        For advanced customization use cases, a <code>useRadioGroup()</code>{" "}
...
`}
      ...
      <ul>
        <li>
          <code>value.name</code> (<em>string</em> [optional]): The name used to
          reference the value of the control.
        </li>
        <li>
          <code>value.onChange</code> (<em>func</em> [optional]): Callback fired
          when a radio button is selected.
        </li>
        <li>
          <code>value.value</code> (<em>any</em> [optional]): Value of the
