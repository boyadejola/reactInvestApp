...
function SwitchesDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        <code>FormGroup</code> is a helpful wrapper used to group selection
        controls components that provides an easier API. However, you are
        encouraged to use <a href="/components/checkboxes/">Checkboxes</a>{" "}
      ...
      <Typography className="mb-40" component="div">
        The switch also comes with an unstyled version. It&#39;s ideal for doing
...
`}
      ...
      <Typography className="mb-40" component="div">
        The <code>SwitchUnstyled</code> component provides default components
        and assigns CSS classes you can style entirely on your own. You are free
        to choose any styling solution - plain CSS classes, a CSS framework,
        Emotion, etc. It is also possible to replace these default components by
        other HTML elements or custom components.
      </Typography>
      <Typography className="mb-40" component="div">
        There are three components you can override by the{" "}
        <code>components</code> prop: <code>Root</code>, <code>Thumb</code> and{" "}
        <code>Input</code>. Each one&#39;s props can be set using the{" "}
        <code>componentsProps</code> object.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        For the ultimate customizability, a <code>useSwitch</code> hook is
        available. It accepts almost the same options as the SwitchUnstyled
        component minus the <code>component</code>, <code>components</code>, and{" "}
        <code>componentsProps</code> props.
      </Typography>
...
`}
      ...
      <ul>
        <li>
          It will render an element with the <code>checkbox</code> role not{" "}
          <code>switch</code> role since this role isn&#39;t widely supported
          yet. Please test first if assistive technology of your target audience
          supports this role properly. Then you can change the role with
        ...
        <li>
          ...
          additional attribute (e.g. <code>aria-label</code>,{" "}
          <code>aria-labelledby</code>, <code>title</code>) via the{" "}
