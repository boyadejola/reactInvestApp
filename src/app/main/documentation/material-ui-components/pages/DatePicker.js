  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        Date pickers let the user select a date. Date pickers are displayed
        with:
      </Typography>
      <ul>
      ...
      <Typography className="mb-40" component="div">
        This component relies on the date management library of your choice. It
        supports <a href="https://date-fns.org/">date-fns</a>,{" "}
        <a href="https://moment.github.io/luxon/">luxon</a>,{" "}
        <a href="https://github.com/iamkun/dayjs">dayjs</a>,{" "}
        <a href="https://momentjs.com/">moment</a> and any other library via a
        public <code>dateAdapter</code> interface.
      </Typography>
      <Typography className="mb-40" component="div">
        Please install any of these libraries and set up the right date engine
        by wrapping your root (or the highest level you wish the pickers to be
        available) with <code>LocalizationProvider</code>:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        and text field. This can be helpful when building custom popover/modal
        containers.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        The date picker component is designed and optimized for the device it
        runs on.
      </Typography>
      <ul>
        <li>
          The <code>MobileDatePicker</code> component works best for touch
          devices and small screens.
        </li>
        <li>
          The <code>DesktopDatePicker</code> component works best for mouse
          devices and large screens.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        By default, the <code>DatePicker</code> component renders the desktop
        version if the media query{" "}
        <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@media/pointer">
          <code>@media (pointer: fine)</code>
        </a>{" "}
        matches. This can be customized with the{" "}
        <code>desktopModeMediaQuery</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Use <code>LocalizationProvider</code> to change the date-engine locale
        that is used to render the date picker. Here is an example of changing
        the locale for the <code>date-fns</code> adapter:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Install <code>date-fns-jalali</code> and use{" "}
        <code>@date-io/date-fns-jalali</code> adapter to support{" "}
        <a href="https://en.wikipedia.org/wiki/Jalali_calendar">
          Jalali calendar
        </a>
        .
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        It&#39;s possible to combine <code>year</code>, <code>month</code>, and{" "}
        <code>date</code> selection views. Views will appear in the order
        they&#39;re included in the <code>views</code> array.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        For ease of use, the date picker will automatically change the layout
        between portrait and landscape by subscription to the{" "}
        <code>window.orientation</code> change. You can force a specific layout
        using the <code>orientation</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Some lower-level sub-components (<code>CalendarPicker</code>,{" "}
        <code>MonthPicker</code>, and <code>YearPicker</code>) are also
        exported. These are rendered without a wrapper or outer logic (masked
        input, date values parsing and validation, etc.).
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>renderInput</code> prop. Make sure to spread <code>ref</code> and{" "}
        <code>inputProps</code> correctly to the custom input component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The displayed days are customizable with the <code>renderDay</code>{" "}
        function prop. You can take advantage of the{" "}
        <a href="/api/pickers-day/">PickersDay</a> component.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Sometimes it may be necessary to display additional info right in the
        calendar. Here&#39;s an example of prefetching and displaying
        server-side data using the <code>onMonthChange</code>,{" "}
        <code>loading</code>, and <code>renderDay</code> props.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
