  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        application and can be used for creating loaders, dialogs, and more. In
        its simplest form, the backdrop component will add a dimmed layer over
        your application.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        The backdrop also comes with the unstyled package. It&#39;s ideal for
        doing heavy customizations and minimizing bundle size.
      </Typography>
