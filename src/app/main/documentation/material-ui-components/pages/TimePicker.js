  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        Time pickers allow the user to select a single time (in the
        hours:minutes format). The selected time is indicated by the filled
...
`}
      ...
      <Typography className="mb-40" component="div">
        The time picker component is designed and optimized for the device it
        runs on.
      </Typography>
      <ul>
        <li>
          The <code>MobileTimePicker</code> component works best for touch
          devices and small screens.
        </li>
        <li>
          The <code>DesktopTimePicker</code> component works best for mouse
          devices and large screens.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
        By default, the <code>TimePicker</code> component renders the desktop
      ...
      <Typography className="mb-40" component="div">
        ...
        that is used to render the time picker. The time picker will
        automatically adjust to the locale&#39;s time setting, i.e. the 12-hour
        or 24-hour format. This can be controlled with <code>ampm</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Some lower-level sub-components (<code>ClockPicker</code>) are also
