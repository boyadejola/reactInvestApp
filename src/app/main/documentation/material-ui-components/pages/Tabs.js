...
function TabsDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        <code>@mui/lab</code> offers utility components that inject props to
        implement accessible tabs following{" "}
      ...
      <Typography className="mb-40" component="div">
        Long labels will automatically wrap on tabs. If the label is too long
        for the tab, it will overflow, and the text will not be visible.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        The <code>variant='fullWidth'</code> prop should be used for smaller
        views. This demo also uses{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        the viewport width with <code>{`scrollButtons={true}`}</code>{" "}
        <code>allowScrollButtonsMobile</code>:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>{`scrollButtons={false}`}</code>. All scrolling must be initiated
        through user agent scrolling mechanisms (e.g. left/right swipe, shift
        mouse wheel, etc.)
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>visibleScrollbar</code>.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Nav tabs
      </Typography>
      <Typography className="mb-40" component="div">
        By default, tabs use a <code>button</code> element, but you can provide
        your custom tag or component. Here&#39;s an example of implementing
        tabbed navigation:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        without an HTTP round-trip to the server. The <code>Tab</code> component
        provides the <code>component</code> prop to handle this use case. Here
        is a <a href="/guides/routing/#tabs">more detailed guide</a>.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Accessibility
      </Typography>
      ...
      <ol>
        <li>
          Label <code>Tabs</code> via <code>aria-label</code> or{" "}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="#experimental-api">an experimental API</a> in{" "}
        <code>@mui/lab</code> that does not require extra work.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Keyboard navigation
      </Typography>
      <Typography className="mb-40" component="div">
        ...
        <code>selectionFollowsFocus</code> to the <code>Tabs</code> component.
        The WAI-ARIA authoring practices have a detailed guide on{" "}
      ...
      <Typography className="mb-40" component="div">
        The following two demos only differ in their keyboard navigation
        behavior. Focus a tab and navigate with arrow keys to notice the
        difference, e.g. <kbd className="key">Arrow Left</kbd>.
      </Typography>
