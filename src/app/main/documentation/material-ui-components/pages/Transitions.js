  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="https://material.io/design/motion/">motion</a> to your
        applications.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>orientation</code> prop if you need a horizontal collapse. The{" "}
        <code>collapsedSize</code> prop can be used to set the minimum
      ...
      <Typography className="mb-40" component="div">
        Expands outwards from the center of the child element, while also fading
        in from transparent to opaque.
      </Typography>
      <Typography className="mb-40" component="div">
        The second example demonstrates how to change the{" "}
        <code>transform-origin</code>, and conditionally applies the{" "}
        <code>timeout</code> prop to change the entry speed.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        Slide in from the edge of the screen. The <code>direction</code> prop
        controls which edge of the screen the transition starts from.
      </Typography>
      <Typography className="mb-40" component="div">
        The Transition component&#39;s <code>mountOnEnter</code> prop prevents
        the child component from being mounted until <code>in</code> is{" "}
        <code>true</code>. This prevents the relatively positioned component
        from scrolling into view from its off-screen position. Similarly, the{" "}
        <code>unmountOnExit</code> prop removes the component from the DOM after
      ...
      <Typography className="mb-40" component="div">
        The Slide component also accepts <code>container</code> prop, which is a
        reference to a DOM node. If this prop is set, the Slide component will
        slide from the edge of that DOM node.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <ul>
        <li>
          <strong>Forward the style</strong>: To better support server
          rendering, MUI provides a <code>style</code> prop to the children of
          some transition components (Fade, Grow, Zoom, Slide). The{" "}
          <code>style</code> prop must be applied to the DOM for the animation
          to work as expected.
        </li>
        <li>
          <strong>Forward the ref</strong>: The transition components require
          the first child element to forward its ref to the DOM node. For more
          details about ref, check out{" "}
          <a href="/guides/composition/#caveat-with-refs">Caveat with refs</a>
        </li>
        <li>
          <strong>Single element</strong>: The transition components require
          only one child element (<code>React.Fragment</code> is not allowed).
        </li>
      </ul>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        component from <em>react-transition-group</em>. As components are added
        or removed, the <code>in</code> prop is toggled automatically by{" "}
        <code>TransitionGroup</code>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>TransitionComponent</code> prop to customize the default
        transition. You can use any of the above components or your own. It
        should respect the following conditions:
      </Typography>
      <ul>
        <li>
          Accepts an <code>in</code> prop. This corresponds to the open/close
          state.
        </li>
        <li>
        ...
        <li>
          ...
          is completed. These two callbacks allow to unmount the children when
          in a closed state and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
