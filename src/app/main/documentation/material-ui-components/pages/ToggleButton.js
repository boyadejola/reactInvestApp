  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        selected state of its child buttons when given its own{" "}
      ...
      <Typography className="mb-40" component="div">
        In this example, text justification toggle buttons present options for
        left, center, right, and fully justified text (disabled), with only one
      ...
      <Typography className="mb-40" component="div">
        Multiple selection allows for logically-grouped options, like bold,
      ...
      <Typography className="mb-40" component="div">
        The buttons can be stacked vertically with the <code>orientation</code>{" "}
      ...
      <Typography className="mb-40" component="div">
        If you want to enforce that at least one button must be active, you can
        adapt your handleChange function.
      </Typography>
...
`}
      ...
      <ul>
        <li>
          ToggleButtonGroup has <code>role='group'</code>. You should provide an
          accessible label with <code>aria-label='label'</code>,{" "}
          <code>aria-labelledby='id'</code> or <code>{`<label>`}</code>.
        </li>
        <li>
          ToggleButton sets <code>{`aria-pressed='<bool>'`}</code> according to
          the button state. You should label each button with{" "}
      ...
      <Typography className="mb-40" component="div">
        At present, toggle buttons are in DOM order. Navigate between them with
        the tab key. The button behavior follows standard keyboard semantics.
      </Typography>
    </>
  );
}
