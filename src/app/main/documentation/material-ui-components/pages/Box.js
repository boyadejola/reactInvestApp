  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/system/basics/#all-inclusive">all the style functions</a> that
      ...
      <Typography className="mb-40" component="div">
        ...
        . In addition, the <code>sx</code> prop allows you to specify any other
        CSS rules you may need. Here&#39;s an example of how you can use it:
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
          iframe={false}
          component={
            require("app/main/documentation/material-ui-components/components/box/BoxSx.js")
              .default
          }
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>{`<div>`}</code> that by default can be changed with the{" "}
        <code>component</code> prop. Let&#39;s say you want to use a{" "}
      ...
      <Typography className="mb-40" component="div">
        However, sometimes you have to target the underlying DOM element. As an
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="left">
              The component used for the root node. Either a string to use a DOM
          ...
          <tr>
            ...
            <td align="left">
              Accepts all system properties, as well as any valid CSS
              properties.
            </td>
          </tr>
        </tbody>
