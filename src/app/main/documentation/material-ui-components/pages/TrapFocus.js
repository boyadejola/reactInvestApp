  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        TrapFocus is a component that manages focus for its descendants. This is
        useful when implementing overlays such as modal dialogs, which should
        not allow the focus to escape while open.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        As the component does not have any styles, it also comes with the
        unstyled package.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        You can disable this behavior with the <code>disableEnforceFocus</code>{" "}
        prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        By default, the component moves the focus to its descendants as soon as
        it opens: <code>{`open={true}`}</code>.
      </Typography>
      <Typography className="mb-40" component="div">
        You can disable this behavior and make it lazy with the{" "}
        <code>disableAutoFocus</code> prop. When auto focus is disabled, as in
        the demo below, the component only traps the focus once it gets focused.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-40" component="div">
        ...
        component to render a subset of the trap focus children into a new
        &quot;subtree&quot; outside of the current DOM hierarchy; so that they
        no longer form part of the focus loop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
