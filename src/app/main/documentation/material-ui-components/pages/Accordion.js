  ...
  return (
    <>
      ...
      <Typography className="description">
        Accordions contain creation flows and allow lightweight editing of an
        element.
      </Typography>

      <Typography className="mb-40" component="div">
        An accordion is a lightweight container that may either be used
        standalone, or be connected to a larger surface, such as a card.
      </Typography>
      <blockquote>
        <Typography className="mb-40" component="div">
          ...
          will continue to support them. It was formerly known as the
          &quot;expansion panel&quot;.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-40" component="div">
        The content of Accordions is mounted by default even if the accordion is
        not expanded. This default behavior has server-side rendering and SEO in
        mind. If you render expensive component trees inside your accordion
        details or simply render many accordions it might be a good idea to
        change this default behavior by enabling the
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>AccordionSummary</code>. The <code>Accordion</code> will derive
        the necessary <code>aria-labelledby</code>
