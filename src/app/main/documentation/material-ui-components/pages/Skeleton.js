  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <strong>directly in your components</strong>. For instance:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        width and height. In these instances, you can pass <code>children</code>{" "}
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>background-color</code> CSS property. This is especially useful
      ...
      <Typography className="mb-40" component="div">
        Skeleton screens provide an alternative to the traditional spinner
        method. Rather than showing an abstract widget, skeleton screens create
        anticipation of what is to come and reduce cognitive load.
      </Typography>
      <Typography className="mb-40" component="div">
        The background color of the skeleton uses the least amount of luminance
        to be visible in good conditions (good ambient light, good screen, no
        visual impairments).
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        ARIA
