  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>transformOrigin</code> positions. You can also set the{" "}
        <code>anchorReference</code> to <code>anchorPosition</code> or{" "}
        <code>anchorEl</code>. When it is <code>anchorPosition</code>, the
        component will, instead of <code>anchorEl</code>, refer to the{" "}
        <code>anchorPosition</code> prop which you can adjust to set the
      ...
      <Typography className="mb-40" component="div">
        This demo demonstrates how to use the <code>Popover</code> component and
        the mouseover event to achieve popover behavior.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          className="my-24"
