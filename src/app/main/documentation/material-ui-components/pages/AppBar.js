...
function AppBarDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        When you render the app bar position fixed, the dimension of the element
        doesn&#39;t impact the rest of the page. This can cause some part of
        your content to be invisible, behind the app bar. Here are 3 possible
        solutions:
      </Typography>
      <ol>
        <li>
          You can use <code>position='sticky'</code> instead of fixed. ⚠️ sticky
...
`}
      ...
      <Typography className="mb-40" component="div">
        You can use the <code>useScrollTrigger()</code> hook to respond to user
        scroll actions.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        The app bar elevates on scroll to communicate that the user is not at
        the top of the page.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        A floating action buttons appears on scroll to make it easy to get back
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>options.disableHysteresis</code> (<em>bool</em> [optional]):
              Defaults to <code>false</code>. Disable the hysteresis. Ignore the
              scroll direction when determining the <code>trigger</code> value.
            </li>
            <li>
              <code>options.target</code> (<em>Node</em> [optional]): Defaults
              to <code>window</code>.
            </li>
            <li>
              <code>options.threshold</code> (<em>number</em> [optional]):
              Defaults to <code>100</code>. Change the <code>trigger</code>{" "}
              value when the vertical scroll strictly crosses this threshold
              (exclusive).
            </li>
          </ul>
        </li>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        , the <code>color</code> prop has no effect on the appearance of the
        AppBar in dark mode. You can override this behavior by setting the{" "}
        <code>enableColorOnDark</code> prop to <code>true</code>.
      </Typography>
