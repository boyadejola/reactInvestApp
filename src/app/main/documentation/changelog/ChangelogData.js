...
const changelogData = [
      ...
      <div className="text-14 p-24 border-2 rounded-16 w-full max-w-lg mt-40 mb-24">
        <ul className="list-disc">
          <Typography component="li" className="leading-loose mb-16">
            Migrating to the new major version (v7.0.0) can be difficult because
            of latest material-ui (v5) integration.
          </Typography>
          <Typography component="li" className="leading-loose">
            You should migrate to material v5 to get the benefits of bug fixes
            and a lot of improvements such as the new styling engine. Checkout
            material-ui migration guide at{" "}
            <a
    ...
    notes: (
      <>
        <Typography
          ...
          component="div"
        >
          Migrating to the new major version (v5.0.0) can be difficult because
          of redux-toolkit integration.
        </Typography>
        <Typography
        ...
        >
          ...
          <ul className="list-disc ml-16">
            ...
            <li>
              RTK resolves many of the arguments related to boilerplate and
              unnecessary code.
              <br />
              <ul className="ml-8">
                As mentioned in its official docs, it helps to solve three major
                problems people had with Redux:
            ...
            <li>
              It makes writing redux easier with the best practices. - Includes
              popular middlewares by default (redux-immutable-state-invariant,
              serializable-state-invariant-middleware thunk)
            </li>
            <li>
              Redux DevTools are supported by default and with a simple flag
              true or false - With the CreateSlice function, you don't always
              have to define action type, action, and reducer separately.
            </li>
            <li>It's possible to mutate state with included ImmerJS.</li>
            <li>
              With the help of another included library Reselect, the
              performance can be improved.
              <br />- createEntityAdapter function generates a set of prebuilt
              reducers and selectors for performing CRUD operations more easily.
            </li>
          </ul>
          <br />
          <b>
            With the changes, We've removed ~57 redux related files from the
            fuse-react.
          </b>
        </Typography>
      </>
  ...
  },
  {
    ...
    fixedChanges: [
      ...
      <span>
        react-select returns null despite of empty array, workaround applied for
        FuseChipSelect.
        <a
  ...
  },
  {
    ...
    newChanges: [
      ...
      <span>
        ...
        (use with attribute{" "}
        <code>{`name="profile.username" value={form.profile.username}`}</code>)
      </span>,
    ],
    fixedChanges: [
  ...
  },
  {
    ...
    newChanges: [
      <span>
        ...
        (New feature of react let you use state and other React features without
        writing a class.)
      </span>,
      ...
      <span>
        user.role can be array to assign multiple permission roles. For details
        checkout
        <a
    ...
    fixedChanges: [
      <span>
        <i>"createBrowserHistroy is not exported from history.js"</i> error on
        windows environment(rare)
      </span>,
    ],
    breakingChanges: [
      <span>
        react-loadable changed with React.suspense, React.lazy. All route
        configs updated with React.lazy
      </span>,
      "classNames() replaced with clsx().",
      <span>
        We have no longer support Internet Explorer by default. If you still
    ...
    notes: (
      <Typography
        ...
        component="div"
      >
        Migrating to the new major version (<b>v3.0.0</b>) can be difficult
        because of the hooks support and major dependency releases.
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    notes: (
      <Typography
        ...
        component="div"
      >
        Migrating to the new major version (v2.0.0) can be difficult because of
        the project structure and layout system changes.
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    newChanges: [
      ...
      <span>
        <b>firebaseService</b> and <b>auth0Service</b> created, <b>Auth</b>{" "}
        component added as entry point for authentication.
      </span>,
  ...
  },
  {
    ...
    newChanges: [
      <span>
        <code>velocity-react</code> added as dependency, its used for
        fuseAnimation
      </span>,
      <span>
