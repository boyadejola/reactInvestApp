  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        Fuse React supports Right-to-left languages such as Arabic, Persian or
        Hebrew, etc.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        enables right-to-left support by flipping every rule of the jss styles
        on the x-axis. You can write the application left-to-right and then turn
        it into right-to-left using this plugin. Or you can start right-to-left
      ...
      <Typography className="mb-16" component="p">
        ...
        adds a custom direction variant to your tailwind project, letting you
        have custom CSS rules for LTR and RTL layouts. For example:
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        To change the default direction of the Fuse React, you need to change{" "}
        <code>direction</code>
      ...
      <Typography className="mb-16" component="p">
        If you need to change theme direction dynamically, for example when you
        need to change LTR to RTL language, you need dispatch an action as
        below:
      </Typography>
