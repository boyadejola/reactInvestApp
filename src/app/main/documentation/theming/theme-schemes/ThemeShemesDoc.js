  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        The Fuse React uses material-ui's theming by default. You can create
        theme color schemes with defining theme configuration objects.
      </Typography>
      ...
      <Typography className="mb-16" component="p">
        ...
        <code>src/app/fuse-configs/themesConfig.js</code> file.
      </Typography>
