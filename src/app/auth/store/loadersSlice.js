...
const invitesSlice = createSlice({
  ...
  reducers: {
    ...
    setDepositHistoryLoader: (state, action) => {
      state.depositHistoryLoader = action.payload;
    },
    setWithdrawHistoryLoader: (state, action) => {
      state.withdrawHistoryLoader = action.payload;
    },
